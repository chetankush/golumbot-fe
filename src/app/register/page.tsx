              ...
              {registered ? (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-white/40 mb-4">
                    We&apos;ve sent a verification link to <strong className="text-white/70">{formData.email}</strong>. Click the link to verify your account and sign in.
                  </p>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4" suppressHydrationWarning>
                    <div>
                      <label htmlFor="companyName" className="block text-sm font-medium text-white/50 mb-1.5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        suppressHydrationWarning
                      />
                      <p className="mt-1.5 text-xs text-white/20">Min 8 characters, with uppercase, lowercase, and a number</p>
                    </div>

                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-2.5 px-4 bg-purple-600 hover:bg-purple-500 text-white font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-[0_0_30px_rgba(124,58,237,0.3)] mt-1"
                      suppressHydrationWarning
                    >
